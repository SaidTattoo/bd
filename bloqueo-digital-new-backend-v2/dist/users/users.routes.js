...
router.get('/energy-owners', users_controller_1.userController.getEnergyOwners);
/**
 * @swagger
 * /users/{id}:
 *   get:
 ...
 */
router.post('/:id/fingerprints', users_controller_1.userController.addFingerprint);
/**
 * @swagger
 ...
 */
router.post('/:id/fingerprints/validate', users_controller_1.userController.validateFingerprint);
router.get('/fingerprints/find', users_controller_1.userController.findUserByFingerPrint);
router.post('/login', users_controller_1.userController.loginByEmailandPassword);
